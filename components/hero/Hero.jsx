        ...
        <div className={styles.heroContent}>
          ...
          >
            <h1 className={styles.mainHeading}>
              <span className={styles.brandName}>M.M.S WATER DIVINERS</span>
              <span className={styles.tagline}>
                Discovering Water, Sustaining Life
              </span>
            </h1>
            <p className={styles.subtitle}>
              Professional Geophysical Water Survey Experts
            </p>
          </div>
          ...
          >
            ...
            <div className={styles.expertInfo}>
              <h2 className={styles.expertName}>Dhananjay Manohar Sawant</h2>
              <p className={styles.expertTitle}>
                Geophysical Water Survey Expert
              </p>
              <p className={styles.expertExperience}>
                <span className={styles.experienceNumber}>10+</span> Years of
                Excellence
              </p>
            </div>
          </div>
          ...
          >
            <div className={styles.feature}>
              ...
              <span>Advanced Groundwater Scanning</span>
            </div>
            <div className={styles.feature}>
              <div className={styles.featureIcon}>
                <svg
              ...
              <span>Accurate Depth Estimation</span>
            </div>
            <div className={styles.feature}>
              <div className={styles.featureIcon}>
                <svg
          ...
          >
            <a href="tel:9370427023" className={styles.ctaPrimary}>
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
